...
(function($, cultturist) {
    cultturist.addModel('feature', {
        ...
        fields: {
            ...
            image: { type: "values", defaultValue: 12, validation: {min:1}},
        ...
        columns: [
            ...
            { field: "view_count", title: "Кол-во просмотров"},
            { field: "comment_count", title: "Кол-во комментариев"},
